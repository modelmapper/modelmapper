...
class PropertyNameInfoImpl implements PropertyNameInfo {
  ...
  final Stack<Accessor> sourceProperties = new Stack<Accessor>();
  final Stack<Mutator> destinationProperties = new Stack<Mutator>();
  ...
  public List<String[]> getSourcePropertyTypeTokens() {
    if (sourcePropertyTypeTokens == null) {
      ...
      for (Accessor sourceProperty : sourceProperties)
  ...
  void pushSourcePropertyType(Accessor sourceProperty) {
    if (sourcePropertyTypeTokens == null)
      return;
