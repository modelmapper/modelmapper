...
public class PrimitivesTest {
  public void testDefaultValue() {
    ...
    assertEquals(Primitives.defaultValue(Integer.class), 0);
    assertEquals(Primitives.defaultValue(Integer.TYPE), 0);
    assertEquals(Primitives.defaultValue(Long.class), 0L);
    assertEquals(Primitives.defaultValue(Long.TYPE), 0L);
    assertEquals(Primitives.defaultValue(Float.class), 0.0f);
    assertEquals(Primitives.defaultValue(Float.TYPE), 0.0f);
    assertEquals(Primitives.defaultValue(Double.class), 0.0d);
    ...
    assertEquals(Primitives.defaultValue(Boolean.class), false);
